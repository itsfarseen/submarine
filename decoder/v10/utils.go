...
func DecodeArgFromString(metadata *v10.Metadata, r *Reader, typeName string) (any, error) {
	...
	default:
		...
		// but v10 metadata doesn't provide a comprehensive type registry like v14.
