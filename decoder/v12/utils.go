...
func DecodeArgFromString(metadata *v12.Metadata, r *Reader, typeName string) (any, error) {
	...
	default:
		...
		// but v12 metadata doesn't provide a comprehensive type registry like v14.
