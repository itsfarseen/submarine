...
func DecodeEvents(metadata *v11.Metadata, eventBytes []byte) ([]EventRecord, error) {
...
func DecodeEventRecord(metadata *v11.Metadata, r *Reader) (EventRecord, error) {
...
func DecodePalletEvent(metadata *v11.Metadata, r *Reader) (*DecodedPalletVariant, error) {
	...
	eventfulModules := make([]v11.ModuleMetadata, 0)
