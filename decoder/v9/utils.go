...
func DecodeArgFromString(metadata *v9.Metadata, r *Reader, typeName string) (any, error) {
	...
	default:
		...
		// but v9 metadata doesn't provide a comprehensive type registry like v14.
