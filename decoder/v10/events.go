...
func DecodeEvents(metadata *v10.Metadata, eventBytes []byte) ([]EventRecord, error) {
...
func DecodeEventRecord(metadata *v10.Metadata, r *Reader) (EventRecord, error) {
...
func DecodePalletEvent(metadata *v10.Metadata, r *Reader) (*DecodedPalletVariant, error) {
